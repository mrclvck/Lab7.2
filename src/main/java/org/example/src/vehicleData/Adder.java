...
public class Adder {
    ...
    public static void vehicleAdderToDB(Vehicle vehicle) {
        DatabaseConnection.executeStatement("insert into vehicle (id, creator, creationDate, name, enginePower, type, capacity, fuelConsumption, x, y) values ('" + vehicle.getId() + "', '" + vehicle.getCreator() + "', '" + vehicle.getCreationDate() + "', '" + vehicle.getName() + "', '" + vehicle.getEnginePower() + "', '" + vehicle.getType() + "', '" + vehicle.getCapacity() + "', '" + vehicle.getFuelConsumption() + "', '"  + vehicle.getCoordinates().getX() + "', '" + vehicle.getCoordinates().getY() + "')");
